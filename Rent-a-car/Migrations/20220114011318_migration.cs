    ...
    public partial class migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RentCarEventID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentCar", x => x.RentCarEventID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarDetails_CompanyID_CarID",
                table: "CarDetails",
                columns: new[] { "CompanyID", "CarID" },
                unique: true);
